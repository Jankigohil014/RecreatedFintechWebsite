                    ...
                    <div className='max-w-6xl px-4 sm:px-6 mx-auto'>
                        <div className='py-12 md:py-20'>
                            ...
                            <div className='text-center relative mx-auto max-w-xl md:max-w-none md:text-left'>
                                {/* Section Header */}
                                <div
                                    className='mb-12 md:mb-20 md:max-w-3xl  aos-init aos-animate'
                                    data-aos='fade-up'
                                ...
                                <div className='max-w-sm md:max-w-2xl xl:max-w-none md:grid-cols-2 xl:grid-cols-4 grid gap-8 lg:gap-6 items-start mx-auto'>
                                    {/* Pricing Table - 1  */}
                                    <div
                                        className='flex flex-col rounded-br-[100px] px-6 py-5 h-full relative aos-init aos-animate'
                                        data-aos='fade-up'
                                        data-aos-anchor='[data-aos-id-7]'
                                        data-aos-delay='100'
                                    >
                                    ...
                                    {/* Pricing Table - 2 */}
                                    <div
                                        className='flex flex-col rounded-br-[100px] bg-gradient-to-b from-blue-100 to-blue-50 px-6 py-5 h-full relative aos-init aos-animate'
                                        data-aos='fade-up'
                                        data-aos-anchor='[data-aos-id-7]'
                                        data-aos-delay='200'
                                    >
