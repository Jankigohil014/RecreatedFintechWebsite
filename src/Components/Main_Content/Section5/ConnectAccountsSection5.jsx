                    ...
                    <div className='max-w-6xl px-4 sm:px-6 mx-auto'>
                        <div className='py-12 md:py-20'>
                            ...
                            <div className='relative mx-auto max-w-xl md:max-w-none text-center md:text-left'>
                                ...
                                {/* Image */}
                                <div
                                    className='flex justify-center mb-6 aos-init aos-animate'
                                    data-aos='fade-up'
                                    data-aos-delay='100'
                                    data-aos-anchor='[data-aos-id-5]'
                                >
                                ...
                                {/* Items */}
                                <div
                                    className='grid md:grid-cols-3 gap-12 text-left items-start max-w-sm md:max-w-none md:gap-0 md:-mx-9 mx-auto aos-init aos-animate'
                                    data-aos='fade-up'
                                    data-aos-delay='200'
                                    data-aos-anchor='[data-aos-id-5]'
                                >
