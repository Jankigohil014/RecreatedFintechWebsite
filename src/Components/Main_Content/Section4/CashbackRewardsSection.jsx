                        ...
                        <div className='py-12 md:py-20'>
                            ...
                            <div className='flex flex-col items-center text-center relative mx-auto max-w-xl md:max-w-none md:text-left md:flex-row'>
                                ...
                                <div className='max-w-full w-[512px] shrink-0'>
                                    ...
                                    <p
                                        className='text-slate-500 text-lg/6 mb-6 aos-init aos-animate'
                                        data-aos='fade-up'
                                        data-aos-anchor='[data-aos-id-4]'
                                        data-aos-delay='200'
                                    >
                                    ...
                                    {/* List */}
                                    <div
                                        className='mb-8 sm:columns-2 pointer-events-none aos-init aos-animate'
                                        data-aos='fade-up'
                                        data-aos-anchor='[data-aos-id-4]'
                                        data-aos-delay='300'
                                    >
                                    ...
                                    {/* Button */}
                                    <div
                                        className='mx-auto max-w-xs sm:max-w-none aos-init aos-animate'
                                        data-aos='fade-up'
                                        data-aos-anchor='[data-aos-id-4]'
                                        data-aos-delay='300'
                                    >
                                ...
                                <div className='max-w-sm w-full mt-8 md:max-w-none md:ml-8 md:mt-0'>
                                    <div className='relative -mx-8 md:mx-0'>
                                        <img
                                            className='mx-auto md:max-w-none aos-init aos-animate'
                                            src={stores_features}
                                            alt='stores features'
                                            height={496}
                                            width={496}
