                        ...
                        <div className='pt-12 md:py-20'>
                            ...
                            <div className='relative mx-auto max-w-xl text-center md:max-w-none md:text-left'>
                                ...
                                <div className='md:max-w-lg'>
                                    {/* copy */}
                                    <h2
                                        className='mb-4 text-white text-4xl md:text-5xl font-black aos-init aos-animate'
                                        data-aos='fade-up'
                                    ...
                                    <p
                                        className='text-slate-400 text-md tracking-tight mb-8 aos-init aos-animate'
                                        data-aos='fade-up'
                                        data-aos-anchor='[data-aos-id-2]'
                                        data-aos-delay='200'
                                    >
