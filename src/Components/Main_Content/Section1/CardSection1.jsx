...
import classes from './CardSection1.module.css';
...
const CardSection1 = () => {
    return (
        <React.Fragment>
            {/* Card Sections #1 */}
            <section>
                <div className='px-4 max-w-6xl mx-auto sm:px-6'>
                    <div className='py-12 md:pb-12 md:py-28 '>
                        {/* Items */}
                        <div className='grid md:grid-cols-3 gap-12 md:gap-0 items-start max-w-sm md:max-w-none mx-auto md:-mx-9 md:mb-0'>
                            {/* Card Item  */}

                            {CardSvgs.map((svg) => (
                                <div
                                    key={svg.svg_id}
                                    className={`relative md:px-9 aos-init aos-animate ${classes.verticalDivider}`}
                                    data-aos='fade-up'
                                >
                                    <div className='mb-3'> {svg.svgImg}</div>
                                    <CardItem />
                                </div>
                            ))}
                        </div>
