                ...
                <div className='pb-12 pt-28 md:pt-36 md:pb-16'>
                    ...
                    <div className='flex items-center md:hidden mb-8'>
                        ...
                        <div className='flex items-center min-w-0 text-sm/6 whitespace-nowrap ml-3'>
                            ...
                            <svg
                                className=' fill-slate-400 h-3 w-3 shrink mx-2'
                                viewBox='0 0 16 16'
                            >
                                <path d='M6.6 13.4L5.2 12l4-4-4-4 1.4-1.4L12 8z'></path>
                            </svg>
                            <span className='font-medium text-slate-800 text-ellipsis overflow-hidden whitespace-nowrap'>
                    ...
                    <article className='text-slate-500 font-[350] '>
                        <div
                            className='flex items-center mb-4 aos-init aos-animate'
                            data-aos='fade-up'
                        >
                            <svg
                                width='24'
                            ...
                            <span className='text-slate-800 font-bold ml-3 text-lg/6'>
                                Sending money
                            </span>
                        </div>
                        <h2
                            className='mb-4 text-slate-800 text-3xl aos-init aos-animate'
                            data-aos='fade-up'
                        >
                            How do I send money to a bank account or card?
                        </h2>
                        <div className='space-y-6'>
                            <div
                                className='space-y-4 aos-init aos-animate'
                                data-aos='fade-up'
                            >
                                <p>
                    ...
                    {/* Footer */}
                    <footer
                        className='pt-8 border-slate-200 border-t-2 mt-8 aos-init aos-animate'
                        data-aos='fade-up'
                    >
                        <div className='flex items-center space-x-6'>
                            ...
                            <div className='flex items-center space-x-2'>
                                <button className=' inline-flex items-center justify-center shadow-sm bg-blue-500 text-blue-50 whitespace-nowrap rounded-full font-[550] text-sm px-3 py-2'>
                                    <svg
                                        className='shrink-0 mr-2 fill-blue-300'
                                        width='12'
                                        height='13'
                                        xmlns='http://www.w3.org/2000/svg'
                                    >
