                ...
                <div className='pt-36 md:pt-40 md:pb-20 '>
                    <div className='relative mx-auto max-w-xl text-center md:text-left md:max-w-none '>
                        ...
                        <div className={classes.content}>
                            <h1
                                className='text-white font-bold text-4xl md:text-6xl  text-center md:text-left mb-6'
                                data-aos='fade-up'
                                data-aos-delay='100'
                            >
                            ...
                            {/* Buttons */}
                            <div
                                className='max-w-xs mb-12 mx-auto sm:flex sm:justify-center md:justify-start sm:max-w-none  md:mb-0 '
                                data-aos='fade-up'
                                data-aos-delay='300'
                            >
                                <div>
